...
export const projects: Project[] = [
  ...
  {
    title: "Wayanad Tourism Website",
    description: "Designed and developed a website for Wayanad tourism as part of an academic project. Implemented an interactive and visually appealing UI using modern web development technologies. Focused on showcasing key tourist attractions, travel information, and user engagement features.",
    tags: ["HTML", "CSS", "JavaScript", "Tailwind CSS", "Web Development"],
  },
  {
    title: "Comparing Human and Machine Knowledge Acquisition",
    description: "Explored the contrast between human learning and AI-based learning through Thomistic philosophy. Analysed the limitations of machine cognition in comparison to the human intellect. Wrote a thesis paper in this domain.",
    tags: ["Philosophy", "AI", "Research", "Thomistic Philosophy"],
  },
]; 