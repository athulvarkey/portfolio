...
import { Mail, Send, Phone, Linkedin } from "lucide-react";
    ...
    <div className="container py-12">
      ...
      >
        ...
        <p className="mt-4 text-gray-500 dark:text-gray-400 max-w-[700px]">
          Have a question or want to discuss research opportunities? Feel free to reach out!
        </p>
      </motion.div>
        ...
        >
          <Card>
            ...
            <CardContent className="space-y-4">
              <Link
                href="mailto:athulvarkey01@gmail.com"
                className="flex items-center space-x-2 text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
              >
                <Mail className="w-5 h-5" />
                <span>athulvarkey01@gmail.com</span>
              </Link>
              <Link
                href="https://in.linkedin.com/in/athul-varkey-23323124b"
                target="_blank"
